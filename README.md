## Обновление 5.2.1
* Теперь Наборы создаются корретно, а не пустыми.
## Обновление 5.2.0
* Обновлена механика получения заклинаний классами, которые могут изменять подготовку.
* Добавлено меню получения стартового снаряжения для Классов и Предысторий.
* Добавлена настройка, позволяющая выбрать то, какие проверки будут видны только Мастеру.
## Обновление 5.1.4
* Добавлены рекомендуемые параметры. См. параметры модуля.
* Добавлена кастомная система света для Факела, Ламп, Свечи и двух видов Фонарей.
* Полностью обновлен перевод dnd.su и теперь соответствует последней версии с сайта.
## Обновление 5.1.3
* Добавлена интеграция с Gambit's Premades.
* Полностью обновлён перевод классов от dndsu.
## Обновление 5.1.2
* Обновлёна интеграция с CPR.
* Добавлен перевод умений, заклинаний и черт 2024 в CPR.
* Для черт Стихийный адепт и Посвященный в магию были добавлены выборы.
## Обновление 5.1.1
* Миграция аур с модуля Active Auras -> Aura Effects.
## Обновление 5.1.0
